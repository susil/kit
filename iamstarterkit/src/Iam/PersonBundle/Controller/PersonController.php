...
use Iam\PersonBundle\Form\PersonType;
...
class PersonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PersonBundle:Person')->findAll();

        return $this->render('PersonBundle:Person:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PersonBundle:Person:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('PersonBundle:Person:show.html.twig', array(
            'entity'      => $entity,
